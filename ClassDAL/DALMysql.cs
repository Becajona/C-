...
namespace ClassDAL
{
    public class DALMysql
    {
        ...
        public Boolean ModificarDB(string SentenciasSQL, MySqlConnection cnab1,ref string msj )
        {
        ...
        // los parametros son objetos sqlParameter que ya los debe de proporcionar 
